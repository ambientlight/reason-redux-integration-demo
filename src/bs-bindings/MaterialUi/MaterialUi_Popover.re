...
external makeProps :
  (
    ~action: 'any_rnfb=?,
    ~anchorEl: 'union_rl2a=?,
    ~anchorOrigin: 'any_rii1=?,
    ~anchorPosition: 'any_rk5w=?,
    ~anchorReference: string=?,
    ~container: 'union_rqo0=?,
    ~elevation: 'number_9=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rauv=?,
    ~_TransitionComponent: 'union_rj48=?,
    ~transitionDuration: 'union_rjzu=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_ryss=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
